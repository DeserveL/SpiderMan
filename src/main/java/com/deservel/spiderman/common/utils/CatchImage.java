...
/**
 * @author DeserveL
 * @date 2017/6/19 22:14
 * @since 1.0.0
 */
public class CatchImage {

    // 地址
    private static final String URL = "https://tieba.baidu.com/p/5156377903";
    // 编码
    ...
    private void Download(List<String> listImgSrc) {
        for (String url : listImgSrc) {
            ...
            try {
                ...
                FileOutputStream fo = new FileOutputStream(new File("D:\\testpic\\" + imageName));
                byte[] buf = new byte[1024];
                int length = 0;
